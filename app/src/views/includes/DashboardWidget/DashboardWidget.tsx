                        ...
                        <div className="w-full px-3 mb-6 md:w-1/2 lg:w-1/4">
                            <div className="h-full max-w-sm p-6 mx-auto bg-gray-500 rounded-xl">
                                ...
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-xs font-semibold text-blue-500">45 GB</span>
                        ...
                        <div className="w-full px-3 mb-6 md:w-1/2 lg:w-1/4">
                            <div className="relative h-full max-w-sm p-6 mx-auto bg-gray-500 rounded-xl">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-sm font-semibold text-gray-300">5 GB</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="flex flex-wrap items-center justify-between -mx-2">
                                    ...
                                    <div className="w-full px-2 md:w-1/2">
                                        <div
                                            ...
                                            style={{ minHeight: "86.7639px" }}
                                        >
                                            <div
                                                id="apexcharts9qt8pchh"
                                                className="apexcharts-canvas apexcharts9qt8pchh apexcharts-theme-light"
                                                style={{ width: 195, height: "86.7639px" }}
                                            >
                                                <svg
                                                    id="SvgjsSvg1001"
                                                    width={195}
                                                    height="86.7638888888889"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    version="1.1"
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <defs id="SvgjsDefs1002">
                                                            <clipPath id="gridRectMask9qt8pchh">
                                                                <rect
                                                                    id="SvgjsRect1004"
                                                                    width="168.5"
                                                                    height="164.5"
                                                            ...
                                                            <clipPath id="forecastMask9qt8pchh" />
                                                            <clipPath id="nonForecastMask9qt8pchh" />
                                                            <clipPath id="gridRectMarkerMask9qt8pchh">
                                                                <rect
                                                                    id="SvgjsRect1005"
                                                                    width="166.5"
                                                                    height="166.5"
                                                            ...
                                                            <g id="SvgjsG1007">
                                                                <g id="SvgjsG1008" className="apexcharts-tracks">
                                                                    ...
                                                                    >
                                                                        <path
                                                                            ...
                                                                            d="M 17.560357259195413 86.82212172383655 A 63.9329268292683 63.9329268292683 0 1 1 144.93964274080457 86.82212172383656"
                                                                            fill="none"
                                                                            fillOpacity={1}
                                                                            stroke="rgba(26,32,44,0.85)"
                                                                            strokeOpacity={1}
                                                                            strokeLinecap="round"
                                                                            strokeWidth="6.683536585365856"
                                                                            strokeDasharray={0}
                                                                ...
                                                                <g id="SvgjsG1011">
                                                                    ...
                                                                    >
                                                                        <path
                                                                            id="SvgjsPath1015"
                                                                            d="M 17.560357259195413 86.82212172383655 A 63.9329268292683 63.9329268292683 0 0 1 110.2749414010314 24.285345084664407"
                                                                            fill="none"
                                                                            fillOpacity="0.85"
                                                                            stroke="rgba(25,75,251,0.85)"
                                                                            strokeOpacity={1}
                                                                            strokeLinecap="round"
                                                                            strokeWidth="6.8902439024390265"
                                                                            strokeDasharray={0}
