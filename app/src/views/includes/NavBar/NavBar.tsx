export default function NavBar() {
    ...
    return (
        <section className="fixed top-0 left-0 z-50 w-full bg-opacity-100">
            <nav className="relative z-50 flex items-center justify-between p-8 mb-3 bg-white">
                <div className="w-full px-2 xl:w-auto bg-opacity-20">
