export default function SideMenu() {
    return (
        <div className="relative w-1/4 h-screen">
            <nav className="flex items-center justify-between p-8 mb-3 bg-gray-700 lg:hidden">
                <div className="w-64 px-2 xl:w-auto xl:mr-12">
            ...
            <div className="relative z-50 hidden lg:block navbar-menu">
                <div className="fixed top-0 left-0 w-64 h-full bg-gray-800 opacity-50 lg:hidden navbar-backdrop" />
                <nav className="fixed top-0 bottom-0 left-0 flex flex-col h-full px-4 py-8 overflow-auto bg-gray-700 max-w-xxs">
                    <div className="mb-6">
                        ...
                        <ul className="mb-8">
                            ...
                            <li className="mb-4">
                                ...
                                >
                                    ...
                                    <span className="flex items-center justify-center w-6 h-6 text-xs font-semibold text-white bg-blue-500 rounded-full">
                                        4
                                    </span>
                                </a>
                            </li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold">Front-End Team</span>
                                    </a>
                                </li>
                                <li>
                                    <a
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold">Back-End Team</span>
                                    </a>
                                </li>
                                <li>
                                    <a
